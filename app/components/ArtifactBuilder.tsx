...
import { ComponentNode, AIGenerationRequest, SandboxResult } from '../types/artifact'
...
export const ArtifactBuilder = () => {
  ...
  const generateFromPrompt = async (request: AIGenerationRequest): Promise<SandboxResult> => {
...
export const GeneratedComponent = () => {
  ...
  const updateComponent = useCallback((id: string, updates: Partial<ComponentNode>) => {
    ...
    <div className="h-screen flex bg-gray-50">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-white border-b border-gray-200 flex items-center px-4">
          <h1 className="text-xl font-semibold text-gray-800">Visual Artifact Studio</h1>
      ...
      <div className="w-80 bg-white border-l border-gray-200">
        ...
        <div className="h-1/2 border-t border-gray-200">
          <StylePanel 
            selectedNode={selectedNode}
            onUpdateNode={(updates) => selectedNode && updateComponent(selectedNode.id, updates)}
          />
        </div>
      </div>
    </div>
