...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://visual-artifact-studio.vercel.app'),
  title: {
  ...
  authors: [
    {
      ...
      url: process.env.NEXT_PUBLIC_SITE_URL || 'https://visual-artifact-studio.vercel.app',
    },
  ],
